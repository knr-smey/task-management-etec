        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700 uppercase">Project Name</th>
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700 uppercase">Team</th>
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700 uppercase">Start Date</th>
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700 uppercase">End date</th>
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700 uppercase">Created By</th>
            ...
            <tbody class="divide-y">
                <?php foreach ($members as $member): ?>
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-gray-700" data-status="<?= $member['is_active'] ?>"></td>
