INSERT INTO users (name, email, password_hash, course, is_active, created_at)
SELECT
  CONCAT('Member ', n),
  CONCAT('member', n, '@example.com'),
  '$2y$10$u1q7FgM5nP9X1zQZdG3ZrO9vmdw.QX4nUEXZbFYk9E0E3CkB8Zwha',
  NULL,
  1,
  NOW()
FROM (
